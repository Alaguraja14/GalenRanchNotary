...
<head>
    <title>Estate Planning contains following documents | Gale Ranch Notary
    </title>
    ...
    <meta property="og:description"
        content="Explore Essential Estate Planning Documents - Secure your future with these 
    crucial legal papers. Expert guidance and insights included. Discover more!
    ">
        ...
        <div class="w-11/12 px-5 py-10 mx-auto">
            ...
            <div class="py-10">
                ...
                <div class="text-center shadow-xl rounded py-4 bg-red-600">
                    <h1 class="text-gray-100 md:text-xl text-base font-semibold tracking-wider">Estate Planning contains
                        following documents</h1>
                </div>

                <div class="py-10 px-5  mt-10">
                    <p class="md:text-xl text-base font-semibold mt-4">Estate Planning contains following documents</p>

                    <ul class="list-decimal py-4 md:px-10 px-4 space-y-3 md:text-base text-sm">
                        ...
                        <li>Deeds. One deed is included in the price. Additional properties cost more
                            <ul class="list-disc  md:px-10 px-4 py-2 md:text-base text-sm">
                                <li>This includes lookup of the chain of title, preparation of the deed (for any state),
                                    the
                                    Preliminary Change of Owner Form, and I record it with the County</li>
                            </ul>
                        </li>
                        <li>Guardianship Nomination and Information – if applicable for minor children.</li>
                        <li>Certificate of Trust.</li>
                    </ul>
                    <p class="md:text-lg text-base font-medium mt-2 px-5"> – Gale Ranch Notary, Apostille and Financial
                        Services</a>
                    </p>
                </div>
                <x-subscribeButton></x-subscribeButton>
                <div class="md:px-5 py-8 flex justify-between border-y-2 w-full sm:text-base text-sm">
                    <a href="/how-to-change-your-legal-name-in-california-and-acorss-the-us"
                        class="text-gray-100 bg-red-600 px-4 py-2 rounded-md"><i
                            class="fa-solid fa-chevron-left mr-1"></i>Previous Post</a>
                    <a href="/estate-planning-will-trust-advance-health-care-directive-2"
                        class="text-gray-100 bg-red-600 px-4 py-2 rounded-md">Next Post<i
